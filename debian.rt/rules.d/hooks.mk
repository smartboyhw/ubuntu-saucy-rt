hook-before-clean::
	...
	cat $(DEBIAN)/config/i386/config.flavour.generic $(DEBIAN)/config-delta >$(DEBIAN)/config/i386/config.flavour.rt
	cat $(DEBIAN)/config/amd64/config.flavour.generic $(DEBIAN)/config-delta >$(DEBIAN)/config/amd64/config.flavour.rt
